...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://raw.githubusercontent.com/MR-AUH404/OLD125/main/aprooval.txt"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/profile.php?id=100003506536433")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ MESSENGER🔰🥰https://m.me/AHSAM.FATHER.OF.HETARS")
	subprocess.check_output(["am", "start", "https://m.me/AHSAM.FATHER.OF.HETARS"])

def irfan():
	
	
	runtxt("\n\033[0;91m🧞‍This tool is offical for AHSAM")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://raw.githubusercontent.com/MR-AUH404/OLD125/main/aprooval.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;37m  ╚═══════════════════════════════════════════╝
\033[1;90m═══════════════════════════════════════════════════════════
\033[1;94m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : AHSAM UL HAQ
\033[1;95m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : MR AUH TERMUX HELPING ZONE 
\033[1;93m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB      : AHSAM UL HAQ 
\033[1;97m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : FUCK U BABY 🍼🐥
\033[1;90m═══════════════════════════════════════════════════════════
    """)
		print("%s [%s•%s] %sTOOL NAME : %sAHSAM UL HAQ JOIYA"%(G,R,G,B,G))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [AHSAM] : %s/%s -> \033[0;92m [ MOBI-OK:%s ]- \033[0;91m[MOBI-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;91m[AHSAM-CP] %s|%s\033[0;97m         "%(uid, pw))
